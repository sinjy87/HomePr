...
public class ImageDAO {
	...
	public List<ImageDTO> list(Map map){
		...
		StringBuffer sql = new StringBuffer();
		sql.append(" select no, name, title, content, viewcnt, to_char(wdate, 'yyyy-mm-dd') wdate , filename, ino,gno, r ");
		sql.append(" from( ");
		sql.append(" select no, name, title, content, viewcnt, wdate, filename, ino ,gno, rownum r ");
		sql.append(" from( ");
		sql.append(" 		select no, name, title, content, viewcnt, wdate, filename, ino ,gno ");
		sql.append(" 		from image ");
