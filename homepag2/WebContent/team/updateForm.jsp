	...
	<fieldset style="width: 50%">
		...
		<form name="frm" action="updateProc.jsp" method="post"
			...
			<table border="1">
				...
				<tr>
					<td colspan="3"><img src="./storage/<%=dto.getFilename()%>">
						<br> <br></td>
				</tr>

				<tr>

					<th colspan="2">이름:<%=dto.getName()%> 성별:<%=dto.getGender()%><br>
					</th>
				...
				<tr>
					...
					<th><input type="text" name="zipcode" size="40%"
						...
						placeholder="주소" value="<%=dto.getAddress1()%>"> <input
						type="text" name="address2" size="80%" id="sample6_address2"
						placeholder="상세주소" value="<%=dto.getAddress2()%>"></th>
				</tr>
